...
`building_imperial_nexus` int(11) NOT NULL DEFAULT '1',
`building_raw_materials_mine_1` int(11) NOT NULL DEFAULT '0',
`building_raw_materials_mine_2` int(11) NOT NULL DEFAULT '0',
`building_raw_materials_mine_3` int(11) NOT NULL DEFAULT '0',
`building_credits_mine_1` int(11) NOT NULL DEFAULT '0',
`building_credits_mine_2` int(11) NOT NULL DEFAULT '0',
`building_credits_mine_3` int(11) NOT NULL DEFAULT '0',
`building_fuel_mine_1` int(11) NOT NULL DEFAULT '0',
`building_fuel_mine_2` int(11) NOT NULL DEFAULT '0',
`building_fuel_mine_3` int(11) NOT NULL DEFAULT '0',
`building_pupulation_hub_1` int(11) NOT NULL DEFAULT '1',
`building_pupulation_hub_2` int(11) NOT NULL DEFAULT '0',
`building_pupulation_hub_3` int(11) NOT NULL DEFAULT '0',
`building_dockyard_1` int(11) NOT NULL DEFAULT '0',
`building_dockyard_2` int(11) NOT NULL DEFAULT '0',
`building_planetary_fortress` int(11) NOT NULL DEFAULT '0',
`building_missile_silo` int(11) NOT NULL DEFAULT '0',
`building_sia` int(11) NOT NULL DEFAULT '0',
`building_missile_silo` int(11) NOT NULL DEFAULT '0',
...
`building_raw_materials_store` int(11) NOT NULL DEFAULT '0',
`building_credits_store` int(11) NOT NULL DEFAULT '0',
`building_energy_tank` int(11) NOT NULL DEFAULT '0',
...
('stat_admin_level', '0'),
('stat_last_update', '0'),
('premium_url', '/game.php?page=officier'),
('merchant_price', '3500'),
('auto_backup', '0'),
('last_backup', '0'),
('last_cleanup', '0'),
...
`planet_raw_material` double(132,8) NOT NULL DEFAULT '0.00000000',
`planet_raw_material_perhour` int(11) NOT NULL DEFAULT '0',
`planet_credits` double(132,8) NOT NULL DEFAULT '0.00000000',
`planet_credits_perhour` int(11) NOT NULL DEFAULT '0',
`planet_fuel` double(132,8) NOT NULL DEFAULT '0.00000000',
`planet_fuel_perhour` int(11) NOT NULL DEFAULT '0',
`planet_population_used` int(11) NOT NULL DEFAULT '0',
`planet_population_max` bigint(20) NOT NULL DEFAULT '0',

...
<body>
    <div id="start">
        <h1>
            <img src="{game_logo}" class="logo-main logo-loading" alt="Galaxy Warlords Logo">
        </h1>
    ...
    <!--<div id="start">
        ...
        <div id="footer">
            <div id="footerContent">
                <p id="copyright">Powered by <a href="https://xgproyect.org/" target="_blank" title="Galaxy Warlods {version}">Galaxy Warlods</a> © 2024 - {year}.</p>
            </div>
        </div>-->

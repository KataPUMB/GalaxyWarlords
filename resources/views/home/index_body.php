...
<head>
    ...
    <meta name="author" content="KataPUMB">
    <meta name="publisher" content="Galaxy Warlods">
    <meta name="copyright" content="Galaxy Warlods">
    ...
    <link rel="stylesheet" type="text/css" href="{css_path}starfield.css">
            ...
            $.validationEngineLanguage = {
                newLang: function() {
                    $.validationEngineLanguage.allRules = {
                        ...
                        "confirm": {
                            "regex": "none",
                            "alertText": "* This fields do not match."
                        },
                        "telephone": {
                            "regex": "/^[0-9\-\(\)\ ]+$/",
...
<body style="margin: 0;padding: 0;">
    <div id="start">
        ...
        <a id="registerBtn" href="javascript:void(0)" title="Register">
            {hm_reister_button}
        </a>
        <div id="subscribe">
                ...
                <div class="input-wrap first">
                    ...
                    <div id="server" style="position:relative;">
                        ...
                        <div id="uni_selection" style="display: none;">
                            <div id="row-0" class="server-row " title="" onclick="select_uni('{base_path}','{hm_universe_name}');"
        ...
        <div class="logoContainer">
            <img src="public/images/home/sqareLogoCentred.png">
